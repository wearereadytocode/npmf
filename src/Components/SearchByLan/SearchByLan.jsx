...
function SearchByLan() {
    const history = useHistory()
    const handleSearchByLan = (term) =>{
        history.push(`/result?term=${term}`)
    }
    return (
        <div className="SearchByLan">
            <div className="container">
                <h2>Search by popular Languages</h2>
                <div className="row">
                    <div className="col-md-4" onClick={()=>{
                        handleSearchByLan("vanilajs")
                    }}>
                        <div className="card">
